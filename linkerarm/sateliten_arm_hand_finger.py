           ...
           #print("Bin im heben modul: ",kttmp,seitetmp,speedtmp,wenigtmp,speed_slow)             
            ...
            if seitetmp[:2] == "li":
                ...
                if readwert == co.arm_heben:
                   ...
                   sprachausgabe('"%s"' %sprache)               
                    ...
                    if wenigtmp == 'ab':
                        ...
                        neuwert = readwert + 25
                        #print("Neuwert nach addition. ",neuwert)
                        if neuwert >= co.arm_heben:            elif subkttmp == 'Mittelfinger':              # Die Hand wird angesprochen
             ...
             SI.write_servopos(co.kfinger,co.kfinger_krumm)
                ...
                print("ausgelesener Wert: ", rechts_rea            elif subkttmp == 'Mittelfinger':              # Die Hand wird angesprochen
             SI.move_servo(co.zfinger, co.zfinger_krumm, co.fast)
             SI.write_servopos(co.zfinger, co.zfinger_krumm)
             ...
             SI.move_servo(co.kfinger, co.kfinger_krumm, co.fast)
             SI.write_servopos(co.kfinger,co.kfinger_krumm)dwert,"Konstant: ",co.arm_heben,"Neuwert: ",rechts_neuwert)
...
#                if readwert == co.li_auge_schliessen:
                    #print("Pups")
#                    sprache="aber mein linkes Auge ist            elif subkttmp == 'Mittelfinger':              # Die Hand wird angesprochen
             SI.move_servo(co.zfinger, co.zfinger_krumm, co.fast)
             SI.write_servopos(co.zfinger, co.zfinger_krumm)
             ...
             SI.move_servo(co.kfinger, co.kfinger_krumm, co.fast)
             SI.write_servopos(co.kfinger,co.kfinger_krumm) schon zu"
#                    sprachausgabe('"%s"' %sprache)
#                else:
                    #print("Inder Else: ",wenigtmp)
#                    if wenigtmp == 'ab':                        # wenn nur eine kleine Bewegung gewünscht wird
...
#                   sprachausgabe('"%s"' %sprache)                 elif subkttmp == 'Mittelfinger':              # Die Hand wird angesprochen
             SI.move_servo(co.zfinger, co.zfinger_krumm, co.fast)
             SI.write_servopos(co.zfinger, co.zfinger_krumm)
